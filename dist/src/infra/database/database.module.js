...
const notifications_repository_1 = require("../../app/repositories/notifications-repository");
    ...
    (0, common_1.Module)({
        providers: [
            prisma_service_1.PrismaService,
            {
                ...
                useClass: prisma_notifications_repository_1.PrismaNotificationRepository
            }
        ],
        exports: [
