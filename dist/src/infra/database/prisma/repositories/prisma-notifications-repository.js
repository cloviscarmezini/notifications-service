...
const prisma_notification_helper_1 = require("../../../../app/mappers/prisma-notification-helper");
let PrismaNotificationRepository = class PrismaNotificationRepository {
    ...
    async findById(notificationId) {
        ...
        return prisma_notification_helper_1.PrismaNotificationHelper.toDomain(notification);
    }
    ...
    async findManyByRecipientId(recipientId) {
        ...
        return notifications.map(prisma_notification_helper_1.PrismaNotificationHelper.toDomain);
    }
    async create(notification) {
        const raw = prisma_notification_helper_1.PrismaNotificationHelper.toPrisma(notification);
